...
.DEFAULT_GOAL := help
.PHONY: help version dev-image shell dep pkg-lock pkg-add pkg-remove pkg-update pkg-upgrade web-pkg-lock web-check web-format web-build lint lint-fix format test test-unit test-integration test-coverage test-browser test-real test-real-talkies build run validate-web-network logs doctor replay devices live-fixture live-interview-fixture live-product-fixture benchmark benchmark-with-draft benchmark-candidates benchmark-candidates-with-draft clean
